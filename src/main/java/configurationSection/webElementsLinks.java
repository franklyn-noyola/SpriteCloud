...
public class webElementsLinks {
	...
	public webElementsLinks(WebDriver driver) {
		this.driver = driver;
		
	}
	
	@FindBy(how=How.XPATH, using = "//*[@id='navbarSupportedContent']/ul/li[1]/a)")
	@CacheLookup
		WebElement homeTabLink;
	
	@FindBy(how=How.XPATH, using = "//*[@id='title']")
	@CacheLookup
		WebElement homePageTitlePath;
	
	@FindBy(how=How.XPATH, using = "//*[@id='navbarSupportedContent']/ul/li[2]/a")
	@CacheLookup
		WebElement ResourcesLinkTitlePath;
	
	@FindBy(how=How.XPATH, using = "//*[@id='overview']/div/div[1]/div[1]/h3/a")
	@CacheLookup
		WebElement DynamicIDPath;
